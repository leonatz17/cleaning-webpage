...
<template>
    ...
    <div class="relative lg:mt-10 md:mt-10 sm:mt-60">
        <div>
            <img class="h-60 w-full shrink-0" src="../assets/images/cleanspace.jpg" alt="">
        </div>
        <div class="absolute top-13 ml-5">
            <h1 class="text-white font-sans font-bold text-4xl  text-shadow-lg/30 border border-hidden w-auto">Life is
                Better with Clean Sparks.</h1>
        </div>
        <div class="absolute top-45 ml-5">
            <button class="bg-blue-400 text-[15px] font-bold text-white py-1 px-3 rounded-full cursor-pointer">REQUEST
                AN ESTIMATE</button>
        </div>
    </div>
    ...
    <div class="flex justify-center mt-15 px-10">
        <div class="border border-hidden lg:w-120 md:w-100 sm:w-80 text-center font-serif">
            ...
            <p class="text-[15px]">We provide a space with the certainty that the cleaning solutions we use have been
                ...
                successfully perform top-quality service while remaining safe for families, pets, and belongings.</p>
        </div>
    </div>
    <div class="flex justify-between lg:px-25 md:px-15 sm:px-5 mt-10 lg:shrink-0 md:shrink-0 sm:shrink-0 py-3">
        <img class="h-15 w-15" src="../assets/images/halal.png" alt="">
        <img class="h-15 w-15" src="../assets/images/fda.png" alt="">
        <img class="h-15 w-15" src="../assets/images/iso.png" alt="">
        <img class="h-15 w-15" src="../assets/images/iso2-logo.png" alt="">
        <img class="h-15 w-15" src="../assets/images/eco-friendly-logo.png" alt="">
    </div>
</template>