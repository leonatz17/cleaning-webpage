...
<template>
    ...
    <!-- menu modal  -->
    <div v-if="menu" class="text-white h-auto w-40 bg-blue-200 text-xl text-black shadow-2xl/20 text-center fixed right-40 top-18 z-4000 cursor-pointer font-bold">
