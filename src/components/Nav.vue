<script>
import Menu from '../modal/Menu.vue';
...
<template>
    <div class="fixed top-0 z-1000  w-full ">
        ...
        <div
            ...
            <div class="shrink-0">
                <img class="h-15 w-15 rounded-full" src="../assets/images/logo-cleaning.jpeg" alt="">
            </div>
            ...
            <div>
                <button
                    class="lg:text-[10px] md:text-[10px] sm:text-[8px] bg-blue-200 py-1 px-3 lg:px-2 md:px-2 sm:px-1 text-white rounded-full lg:font-bold md:font-bold sm:font-normal cursor-pointer">GET
                    A QOUTE</button>
            </div>
        </div>
    </div>
    ...
    <!-- menu modal  -->
    <div v-if="menu" class="text-white h-20 w-20 bg-blue-200 text-black text-[10px] shadow-2xl/20 text-center fixed right-40 top-18 z-4000 cursor-pointer font-bold">
