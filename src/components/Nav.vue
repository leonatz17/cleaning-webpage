...
<template>
    ...
    <!-- menu modal  -->
    <div v-if="menu" class="text-white h-30 w-30 bg-blue-200 text-black text-[10px] shadow-2xl/20 text-center fixed right-40 top-18 z-4000 cursor-pointer font-bold">
